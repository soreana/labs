# Code ref : https://medium.com/@ismailakkila/black-hat-python-arp-cache-poisoning-with-scapy-7cb1d8b9d242
...
def restore_network(gateway_ip, gateway_mac, target_ip, target_mac):
    ...
    os.system("echo 1 | tee /proc/sys/net/ipv4/conf/*/send_redirects")
...
if __name__=="__main__":  
    ...
    os.system("echo 0 | tee /proc/sys/net/ipv4/conf/*/send_redirects") # don't send ICMP redirect
    print("[*] Gateway IP address: " + str({gateway_ip}))
    ...
    try:
        sniff_filter = "icmp or ip host " + target_ip
